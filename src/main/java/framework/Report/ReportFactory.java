...
public class ReportFactory {
	...
	public static void configReportExtent() {
		...
		extentSparkReporter = new ExtentSparkReporter(PATH_REPORT + File.separator + "Report_Execucao_" + DateTime.getDateTimeFormatReport() + ".html");
		...
		extentSparkReporter.config().setJs("$('.nav-logo').html('<img src=\"https://i.imgur.com/AjZ89lJ.png%22 class=\"banri-logo\"/>');");
